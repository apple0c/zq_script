...
function AutoRead() {
  return new Promise((resolve, reject) => {
    let url = {
      url: `https://focu.youth.cn/article/share_one?signature=qEkWRmZyvzPO2bBdGX78yKQD8h5K9A5al36xneA0QpKgM9NYL8&scene_id=placed_top&share_id=50794361327114141602584945407&time=1602584948292`,
      headers: {
      'User-Agent': 'KDApp/1.7.8 (iPhone; iOS 14.0; Scale/3.00)'
      }
    };
